...
tutorial () {
	...
	The trouble is that every place that the word $(alt dust) appeared in any of the cookbooks, the Small Troll's magic caused it to swap places with the word $(two places afterward)!
